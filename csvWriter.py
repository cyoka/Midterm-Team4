...
files = os.listdir("../midterm/initial-data")
...
for fname in files:
	...
	f = open("../midterm/initial-data/"+fname, 'r')
	...
	year_set = [int(numeric_string) for numeric_string in table[1]]
	yearday = [int(numeric_string) for numeric_string in table[2]]
	prcpmm = [float(numeric_string) for numeric_string in table[3]]
	tmin_set = [float(numeric_string) for numeric_string in table[5]]
	tmax_set = [float(numeric_string) for numeric_string in table[4]]
	vp_set = [float(numeric_string) for numeric_string in table[6]]
	...
	with open("../midterm/parsed_data/"+fname, "w") as f:
		writer = csv.writer(f)
